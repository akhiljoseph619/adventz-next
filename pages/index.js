    ...
    <>
      ...
      <section className="trust-sec">
        ...
        <div className="trust-shape-rt">
          <img
            src="images/trust-shape.png"
            alt="Website hosing service muscat"
          />
        </div>
        <div className="container-xl">
          <div className="row">
              ...
              <div id="trust-counter" className="trust-cover">
                ...
                <div className="trust-col">
                  <div className="trust-item">
                    ...
                    <figcaption>
                      <h3>
                        <span className="counter-value" data-count="95">
                          0
                        </span>
                        <sup>%</sup>
                      </h3>
              ...
              <div className="testimonial-cover">
                <div className="testimonial-hd">
                  ...
                  <h2>
                    ...
                    <span className="color-red">clients</span>
                  </h2>
                </div>
                    ...
                    <div className="item">
                      <div className="testi-item">
                        ...
                        <div className="testi-item-body">
                          <p>
                            I'd like to share with you my feedback on your
                            services that offered to us. <br /> <br />
                            You have really a great team, making amazing things
                            together. I really love and appreciate the way that
                            you reply to us quickly. Delivering the required
                            ideas in the best possible ways is the factor which
                            allow us continue working together and maintain a
                            long relationship.
                          </p>
                        </div>
                      </div>
